...
import com.openxu.ys.BaseActivity;
import com.openxu.ys.R;

import org.json.JSONException;
import org.json.JSONObject;

public class DictationOffLineTestActivity extends BaseActivity {
    ...
    protected int getLayoutID() {
        return R.layout.activity_dictation_test;
    }

    @Override
    protected void initView() {
        super.initView();
        title_layout.setTextcenter("离线听写测试").show();
    ...
    // 清空参数
        ...
        //引擎类型
        mIat.setParameter( SpeechConstant.ENGINE_TYPE, SpeechConstant.TYPE_LOCAL);  //cloud  local
//        mIat.setParameter(SpeechConstant.ACCENT, "mandarin");//下载语音+  离线识别需要用这个
...
//        resourcce设置种包含两个资源，common.jet 和 sms_16k.jet, 从资源配置中可以看出，目前离线听写仅支持16k音频
    ...
    private RecognizerListener mRecognizerListener = new RecognizerListener() {
        ...
        public void onError(SpeechError speechError) {
            String error = "onError："+speechError.getErrorCode()+" "+speechError.getErrorDescription();
            appendPro(error);
